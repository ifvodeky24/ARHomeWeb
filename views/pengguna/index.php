    ...
    <div class="box">
      ...
      <table id="example1" class="table table-bordered table-striped">
          ...
          <tr>
            ...
            <td> <center>
          <?= Html::a('<i class="fa fa-search"></i>', ['/pengguna/view','id'=>$db['id_pengguna']], ['class' => 'btn btn-warning']) ?>
          <?= Html::a('<i class="fa fa-pencil"></i>', ['/pengguna/update','id'=>$db['id_pengguna']], ['class' => 'btn btn-info']) ?>
