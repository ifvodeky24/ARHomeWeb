    ...
    <div class="box">
      ...
      <table id="example1" class="table table-bordered table-striped">
          ...
          <tr>
            ...
            <td> <center>
          <?= Html::a('<i class="fa fa-search"></i>', ['/pemesanan-kos/view','id'=>$db['id_pemesanan_kos']], ['class' => 'btn btn-warning']) ?>
          <?= Html::a('<i class="fa fa-pencil"></i>', ['/pemesanan-kos/update','id'=>$db['id_pemesanan_kos']], ['class' => 'btn btn-info']) ?>
